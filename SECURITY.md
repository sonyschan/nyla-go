...
#### Latest Release Security Scan (v1.8.1)
- **VirusTotal**: [Scan Results - Pending Upload](https://www.virustotal.com/) - Upload releases/nyla-go-v1.8.1-extension-only.zip for verification ⏳
