...
#### Latest Release Security Scan (v1.7.1)
- **VirusTotal**: [Scan Results - Pending Upload](https://www.virustotal.com/) - Upload releases/nyla-go-v1.7.1-extension-only.zip for verification ⏳
