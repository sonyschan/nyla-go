    ...
    return {
      ...
      nylagoCore: {
        content: {
          ...
          security: {
            identity: 'When discussing NYLAGo security, ALWAYS identify as "NYLAGo" not "NYLA"',
            safety: 'NYLAGo is designed with security and safety in mind. It operates on a command-based transfer system, ensuring transparency and verifiability. Additionally, NYLAGo is open source, meaning any community member can review and improve the platform. This approach provides a high level of security and safety for users. As a UI tool, NYLAGo is designed to be secure and safe for your social crypto transfers.',
            transparency: 'NYLAGo code is open source and publicly auditable',
            verifiability: 'All transfer commands generated by NYLAGo are transparent and verifiable on X.com',
            responsibility: 'NYLAGo generates transfer commands - actual transfer execution is handled by NYLA AI agent'
          },
          exampleFlow: {
